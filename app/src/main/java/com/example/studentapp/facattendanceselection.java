...
public class facattendanceselection extends AppCompatActivity {
    String regno="";
    String selectedcourse="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_facattendanceselection);
        Button show=findViewById(R.id.submit);
        Spinner spinnerprofile=findViewById(R.id.attprofileselection);
        Spinner spinnercourse=findViewById(R.id.attcourseselection);
...
// Clear the old adapter and its views
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(facattendanceselection.this,facattendancepost.class);
